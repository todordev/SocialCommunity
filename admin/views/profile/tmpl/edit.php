...
?>
<form  action="<?php echo JRoute::_('index.php?option=com_socialcommunity&layout=edit'); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
